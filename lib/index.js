  ...
  this.end = function (fn) {
    ...
    function attemptRetry () {
      ...
      return oldEnd.call(selfClone, function (err, res) {
        ...
        else self.emit('response', {status: 'RETRY(' + err.code + ')' }); //emits response event that works with superagent - logger in a single aditional middleware scenario; do not copy
